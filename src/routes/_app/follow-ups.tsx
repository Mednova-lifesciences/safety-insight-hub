  ...
  head: () => ({
    meta: [
      { title: "Follow-ups — MedNova PV Assist" },
      {
        name: "description",
        content:
          "Outstanding follow-up information requests to reporters, with due dates and response status.",
      },
      { property: "og:title", content: "Follow-ups — MedNova PV Assist" },
      {
        property: "og:description",
        content: "Track reporter information requests across open safety cases.",
      },
    ],
  }),
  component: () => (
                        ...
                        <tr key={f.id} className="border-b border-border last:border-0">
                          <td className="px-3 py-2">
                            <Link
                              ...
                              className="mono-num text-primary hover:underline"
                            >
                              {f.caseId}
                            </Link>
                          </td>
